...
gdjs.Modulo_321Code.mapOfGDgdjs_9546Modulo_9595321Code_9546GDHandRObjects1Objects = Hashtable.newFrom({"HandR": gdjs.Modulo_321Code.GDHandRObjects1});
...
gdjs.copyArray(runtimeScene.getObjects("HandR"), gdjs.Modulo_321Code.GDHandRObjects1);
...
{for(var i = 0, len = gdjs.Modulo_321Code.GDHandRObjects1.length ;i < len;++i) {
    gdjs.Modulo_321Code.GDHandRObjects1[i].hide(false);
}
}
...
{for(var i = 0, len = gdjs.Modulo_321Code.GDHandRObjects1.length ;i < len;++i) {
    gdjs.Modulo_321Code.GDHandRObjects1[i].setX(gdjs.evtTools.input.getCursorX(runtimeScene, "UI", 0));
}
}
{for(var i = 0, len = gdjs.Modulo_321Code.GDHandRObjects1.length ;i < len;++i) {
    gdjs.Modulo_321Code.GDHandRObjects1[i].setY(gdjs.evtTools.input.getCursorY(runtimeScene, "UI", 0));
}
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Modulo_321Code.mapOfGDgdjs_9546Modulo_9595321Code_9546GDHandRObjects1Objects, gdjs.Modulo_321Code.mapOfGDgdjs_9546Modulo_9595321Code_9546GDNextButtonObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
/* Reuse gdjs.Modulo_321Code.GDHandRObjects1 */
/* Reuse gdjs.Modulo_321Code.GDNextButtonObjects1 */
{for(var i = 0, len = gdjs.Modulo_321Code.GDHandRObjects1.length ;i < len;++i) {
    gdjs.Modulo_321Code.GDHandRObjects1[i].setLayer("UI");
}
}
{for(var i = 0, len = gdjs.Modulo_321Code.GDHandRObjects1.length ;i < len;++i) {
    gdjs.Modulo_321Code.GDHandRObjects1[i].setZOrder((( gdjs.Modulo_321Code.GDNextButtonObjects1.length === 0 ) ? 0 :gdjs.Modulo_321Code.GDNextButtonObjects1[0].getZOrder()) + 1);
}
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Modulo_321Code.mapOfGDgdjs_9546Modulo_9595321Code_9546GDHandRObjects1Objects, gdjs.Modulo_321Code.mapOfGDgdjs_9546Modulo_9595321Code_9546GDCuoreObjects1Objects, false, runtimeScene, false);
}
if (isConditionTrue_0) {
