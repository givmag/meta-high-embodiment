...
gdjs.IntroCode.mapOfGDgdjs_9546IntroCode_9546GDHandRObjects1Objects = Hashtable.newFrom({"HandR": gdjs.IntroCode.GDHandRObjects1});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.IntroCode.mapOfGDgdjs_9546IntroCode_9546GDHandRObjects1Objects, gdjs.IntroCode.mapOfGDgdjs_9546IntroCode_9546GDNextButtonObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
/* Reuse gdjs.IntroCode.GDHandRObjects1 */
/* Reuse gdjs.IntroCode.GDNextButtonObjects1 */
{for(var i = 0, len = gdjs.IntroCode.GDHandRObjects1.length ;i < len;++i) {
    gdjs.IntroCode.GDHandRObjects1[i].setLayer("UI");
}
}
{for(var i = 0, len = gdjs.IntroCode.GDHandRObjects1.length ;i < len;++i) {
    gdjs.IntroCode.GDHandRObjects1[i].setZOrder((( gdjs.IntroCode.GDNextButtonObjects1.length === 0 ) ? 0 :gdjs.IntroCode.GDNextButtonObjects1[0].getZOrder()) + 1);
}
}
}
