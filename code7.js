...
gdjs.ConclusioneCode.mapOfGDgdjs_9546ConclusioneCode_9546GDHandRObjects1Objects = Hashtable.newFrom({"HandR": gdjs.ConclusioneCode.GDHandRObjects1});
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("HandR"), gdjs.ConclusioneCode.GDHandRObjects1);
{for(var i = 0, len = gdjs.ConclusioneCode.GDHandRObjects1.length ;i < len;++i) {
    gdjs.ConclusioneCode.GDHandRObjects1[i].setX(gdjs.evtTools.input.getCursorX(runtimeScene, "", 0));
}
}
{for(var i = 0, len = gdjs.ConclusioneCode.GDHandRObjects1.length ;i < len;++i) {
    gdjs.ConclusioneCode.GDHandRObjects1[i].setY(gdjs.evtTools.input.getCursorY(runtimeScene, "", 0));
}
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.ConclusioneCode.mapOfGDgdjs_9546ConclusioneCode_9546GDHandRObjects1Objects, gdjs.ConclusioneCode.mapOfGDgdjs_9546ConclusioneCode_9546GDNextButtonObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
/* Reuse gdjs.ConclusioneCode.GDHandRObjects1 */
/* Reuse gdjs.ConclusioneCode.GDNextButtonObjects1 */
{for(var i = 0, len = gdjs.ConclusioneCode.GDHandRObjects1.length ;i < len;++i) {
    gdjs.ConclusioneCode.GDHandRObjects1[i].setZOrder((( gdjs.ConclusioneCode.GDNextButtonObjects1.length === 0 ) ? 0 :gdjs.ConclusioneCode.GDNextButtonObjects1[0].getZOrder()) + 1);
}
}
{for(var i = 0, len = gdjs.ConclusioneCode.GDHandRObjects1.length ;i < len;++i) {
    gdjs.ConclusioneCode.GDHandRObjects1[i].setLayer("UI");
}
}
}
