...
gdjs.Modulo_324Code.mapOfGDgdjs_9546Modulo_9595324Code_9546GDHandRObjects1Objects = Hashtable.newFrom({"HandR": gdjs.Modulo_324Code.GDHandRObjects1});
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("HandR"), gdjs.Modulo_324Code.GDHandRObjects1);
{for(var i = 0, len = gdjs.Modulo_324Code.GDHandRObjects1.length ;i < len;++i) {
    gdjs.Modulo_324Code.GDHandRObjects1[i].setX(gdjs.evtTools.input.getCursorX(runtimeScene, "", 0));
}
}
{for(var i = 0, len = gdjs.Modulo_324Code.GDHandRObjects1.length ;i < len;++i) {
    gdjs.Modulo_324Code.GDHandRObjects1[i].setY(gdjs.evtTools.input.getCursorY(runtimeScene, "", 0));
}
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Modulo_324Code.mapOfGDgdjs_9546Modulo_9595324Code_9546GDHandRObjects1Objects, gdjs.Modulo_324Code.mapOfGDgdjs_9546Modulo_9595324Code_9546GDNextButtonObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
/* Reuse gdjs.Modulo_324Code.GDHandRObjects1 */
/* Reuse gdjs.Modulo_324Code.GDNextButtonObjects1 */
{for(var i = 0, len = gdjs.Modulo_324Code.GDHandRObjects1.length ;i < len;++i) {
    gdjs.Modulo_324Code.GDHandRObjects1[i].setLayer("UI");
}
}
{for(var i = 0, len = gdjs.Modulo_324Code.GDHandRObjects1.length ;i < len;++i) {
    gdjs.Modulo_324Code.GDHandRObjects1[i].setZOrder((( gdjs.Modulo_324Code.GDNextButtonObjects1.length === 0 ) ? 0 :gdjs.Modulo_324Code.GDNextButtonObjects1[0].getZOrder()) + 1);
}
}
}
